...
- (void)viewDidLoad
{
    ...
    YJLSelectView *selectVi=[[YJLSelectView alloc] initWithFrame:CGRectMake(30, 100, 160, 30) title:@"这个是下拉菜单" options:@[@"选项1",@"选项2",@"选项3",@"选项4",@"nima",@"选项135",@"选项16",@"选项10",]];
    selectVi.delegate=self;
    selectVi.menuMaxHeight=0;
    selectVi.menuOffset=CGPointMake(0, 0);
    selectVi.menuWidth=160;
